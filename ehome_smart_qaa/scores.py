            ...
            # else:
                try:
                    ...
                    # if len(json_data['choices']) > 0 :
                        ...
                        # streamrest = str(json_data['choices'][0]['delta']['content'])
                        # res = {
                        #     "code": "0",
                        #     "msg": "操作成功",
                        #     "data": {
